...
/** \class PartialReduxExpr
  ...
  * \tparam Direction indicates the _direction of the redux (#Vertical or #Horizontal)
  *
...
template<typename ExpressionType, int Direction> class VectorwiseOp
{
  ...
  protected:
    ...
    /** \internal
      * \returns the number of subvectors in the _direction \c Direction */
    EIGEN_DEVICE_FUNC
    ...
    /** \internal
      * Replicates a vector in the opposite _direction to match the size of \c *this */
    template<typename OtherDerived>
    EIGEN_DEVICE_FUNC
