...
protected:
	...
	// Methods
public:
	Config(const std::string &cfgPath, std::string keyword = "keyword", std::string delimiter = "=", std::string comment = "#");
	Config(std::istringstream &cfgContent, std::string keyword = "keyword", std::string delimiter = "=", std::string comment = "#");
	Config();
	template <class T>
